...
def test_predict_success(client):
    input_data = """{
        "temp": 0.24, "humidity": 0.81, "season_2": 0, "season_3": 0, "season_4": 0,
        "month_2": 0, "month_3": 0, "month_4": 0, "month_5": 0, "month_6": 0,
        "month_7": 0, "month_8": 0, "month_9": 0, "month_10": 0, "month_11": 0,
        "month_12": 0, "hour_1": 0, "hour_2": 0, "hour_3": 0, "hour_4": 0,
        ...
        "weekday_5": 0, "weekday_6": 1, "workingday_1": 0, "weather_2": 0,
    ...
    assert isinstance(response.json['predictions'][0], (int, float))
