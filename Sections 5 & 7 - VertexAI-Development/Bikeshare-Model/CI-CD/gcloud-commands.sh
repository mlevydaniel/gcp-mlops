...
--project=udemy-mlops \
--worker-pool-spec=replica-count=1,machine-type='n1-standard-4',container-image-uri='us-central1-docker.pkg.dev/dataanalytics-347914/python-apps/cicd-vertex-bikeshare-model' \
...
--artifact-uri='gs://udemy-gcp-mlops/bike-share-rf-regression-artifact/' \
